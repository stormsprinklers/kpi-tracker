...
export function AttributionSetupWizardClient() {
  ...
  async function loadAll() {
    ...
    try {
      ...
      setEvents({
        counts30d: eventsJson.counts30d ?? {},
        sourceSummary30d: eventsJson.sourceSummary30d,
      });
      ...
      >
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs leading-relaxed text-zinc-600 dark:text-zinc-400">
              These are your marketing sources (Facebook, Instagram, GBP, LSA, ChatGPT, Organic (direct), and any custom
              ones). Visits with no tracking link and no{" "}
              <code className="rounded bg-zinc-100 px-1 dark:bg-zinc-800">utm_source</code> are counted under Organic
              (direct). Use the tracking link
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
              ...
              <p className="text-xs text-zinc-500">
                ...
                , and <code className="rounded bg-zinc-100 px-1 dark:bg-zinc-800">CRON_SECRET</code> for the scheduled{" "}
                <code className="rounded bg-zinc-100 px-1 dark:bg-zinc-800">/api/sync</code> cron (twice daily: 12:00 PM and 6:00 PM MST; also polls transcripts).
                Legacy
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-500">
                ...
                Transcripts fill after Intelligence completes; the scheduled <code className="font-mono">/api/sync</code> cron
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="mt-2 text-xs text-zinc-500 dark:text-zinc-400">
                Expandable session history for the reporting period lives on the main{" "}
                <Link href="/insights/attribution" className="font-medium text-emerald-800 underline dark:text-emerald-300">
                  Attribution
                </Link>{" "}
                page.
              </p>
